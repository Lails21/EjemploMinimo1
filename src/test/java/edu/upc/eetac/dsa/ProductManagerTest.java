...
public class ProductManagerTest {
    ...
    //Hay que declarar objecto tipo edu.upc.eetac.dsa.ProductManager
    ...
    public void findAllProductsOrderedbyVentas(){
        ...
        assertEquals(ret.get(0).nombre, "Platano");
        assertEquals(ret.get(1).nombre, "Ciruela");
        assertEquals(ret.get(2).nombre, "Melocotón");
